...
public final class BlockEntityTypes {
    ...
    public static final BlockEntityType<ThresholdingMirrorBlockEntity> THRESHOLDING_MIRROR_BLOCK_ENTITY_TYPE = register(FabricBlockEntityTypeBuilder.create(ThresholdingMirrorBlockEntity::new, Blocks.THRESHOLDING_MIRROR_BLOCK), "thresholding_mirror");
    ...
    public static void init() {
        LuxApi.LUX_RECEIVER_BLOCK_LOOKUP.registerForBlockEntities((blockEntity, context) -> {
            ...
            return null;
        }, MIRROR_BLOCK_ENTITY_TYPE, HALF_SILVERED_MIRROR_BLOCK_ENTITY_TYPE, BRIGHTNESS_MULTIPLIER_BLOCK_ENTITY_TYPE, ONE_WAY_MIRROR_BLOCK_ENTITY_TYPE, THRESHOLDING_MIRROR_BLOCK_ENTITY_TYPE);
