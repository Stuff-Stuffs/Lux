...
public class BrightnessMultiplierBlockEntity extends AbstractPaneBlockEntity {
    public BrightnessMultiplierBlockEntity(final BlockPos blockPos, final BlockState blockState) {
        super(BlockEntityTypes.BRIGHTNESS_MULTIPLIER_BLOCK_ENTITY_TYPE, blockPos, blockState, new BeamInteraction() {
            @Override
            public Vec3d getCollision(final LuxOrb luxOrb, final BlockPos blockPos, final World world, final Vec3d planeNormal, final Vec3d planeOrigin, final AbstractPaneBlockEntity.CollisionResult collisionResult) {
                return collisionResult.collisionPoint;
            }

            @Override
            public void onCollision(final LuxOrb luxOrb, final BlockPos blockPos, final World world, final Vec3d planeNormal, final Vec3d planeOrigin, final AbstractPaneBlockEntity.CollisionResult collisionResult) {
